...
class LmdbDB : public DB {
   ...
   private:
    enum LmdbFormat { kSingleEntry, kRowMajor, kColumnMajor };
    LmdbFormat format_;
    ...
    Status (LmdbDB::*method_read_)(const std::string &, const std::string &,
                                   ...
                                   std::vector<Field> &);
    Status (LmdbDB::*method_scan_)(const std::string &, const std::string &,
                                   int, const std::vector<std::string> *,
                                   std::vector<std::vector<Field>> &);
    Status (LmdbDB::*method_update_)(const std::string &, const std::string &,
                                     std::vector<Field> &);
    Status (LmdbDB::*method_insert_)(const std::string &, const std::string &,
                                     std::vector<Field> &);
